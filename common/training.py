...
class Timer:
    ...
    def time_batch(self, epoch: int, batch: int) -> float:
        ...
        """
        start = self.__batch_starts[epoch].get(batch)
        end = self.__batch_ends[epoch].get(batch)
        # Be robust to missing timestamps or clock anomalies
...
class CheckpointLoader:
    ...
    def __init__(self, checkpoint_path: str) -> None:
        ...
        self.__checkpoint: Dict[str, Any] = torch.load(checkpoint_path, map_location=map_location, weights_only=False)
