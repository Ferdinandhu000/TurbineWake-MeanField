...
# Hardcoded correct checkpoint mapping to prevent YAML file errors for Turbine Wake
CHECKPOINT_MAPPING = {
    "inside": {
        "fno":             "checkpoints_best\\.checkpoints_01_W_FNO_inside_config\\fno1.pt",
        "afno":            "checkpoints_best\\.checkpoints_02_W_AFNO_inside_config\\afno4.pt",
        "transolver":      "checkpoints_best\\.checkpoints_03_W_Transolver_inside_config\\transolver10.pt",
        "flronet":         "checkpoints_best\\.checkpoints_04_W_FLRONet_inside_config\\flronetfno1.pt",
        "CATO-afno":       "checkpoints_best\\.checkpoints_05_W_mean-operator_CATO_afno_inside_config\\flronetafno3.pt",
        "CATO-transolver": "checkpoints_best\\.checkpoints_06_W_mean-operator_CATO_trans_inside_config\\flronettransolver8.pt"
    },
    "outside": {
        "fno":             "checkpoints_best\\.checkpoints_07_W_FNO_outside_config\\fno1.pt",
        "afno":            "checkpoints_best\\.checkpoints_08_W_AFNO_outside_config\\afno4.pt",
        "transolver":      "checkpoints_best\\.checkpoints_09_W_Transolver_outside_config\\transolver8.pt",
        "flronet":         "checkpoints_best\\.checkpoints_10_W_FLRONet_outside_config\\flronetfno16.pt",
        "CATO-afno":       "checkpoints_best\\.checkpoints_11_W_mean-operator_CATO_afno_outside_config\\flronetafno3.pt",
        "CATO-transolver": "checkpoints_best\\.checkpoints_12_W_mean-operator_CATO_trans_outside_config\\flronettransolver8.pt"
    }
}
...
def evaluate_model_for_frames(config_path: str, mode: str, target_frames: list, model_name: str, do_write: bool):
    ...
    sensor_position_path = 'sensor_position_pt/pos.pt'  # Force override to correct pos.pt
    ...
    # Setup data directories matching the turbine wake codebase
    data_dir = config['dataset'].get('data_dir', './data')
    eval_root = os.path.join(data_dir, 'test')
...
if __name__ == "__main__":
    ...
    print("=================== STARTING TURBINE WAKE INSIDE EVALUATIONS ===================")
    ...
    print("\n=================== STARTING TURBINE WAKE OUTSIDE EVALUATIONS ===================")
    for idx, (yaml_file, model_name) in enumerate(model_mappings):
    ...
    print("\n[***] Turbine Wake evaluations completed successfully!")
